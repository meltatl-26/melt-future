...
function HandcraftedPrivacy() {
  return (
    <div style={{ background: 'var(--color-black)', color: 'var(--color-white)', minHeight: '80vh', padding: 'var(--space-4xl) var(--grid-gutter)' }}>
      <div style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <div style={{ fontSize: '0.95rem', lineHeight: 1.8, color: 'rgba(255, 255, 255, 0.6)' }}>
